...
$ijd=$_POST['ijd'];
$sa=$_POST['sa'];
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Password=:password,EmailId=:email,Gender=:gender,Dob=:dob,Phonenumber=:mobileno,Wnumber=:wmobileno,Exte=:ext,BloodGroup=:bg,Role=:role,Job=:jl,OO=:oo,Sub=:sc,Twe=:twe,Ijd=:ijd,Space=:sa where id=:eid";
...
<input id="wmobileno" name="wmobileno" value="<?php echo htmlentities($result->Wnumber);?>" type="tel" maxlength="10" autocomplete="off"  >
 </div>
 
  <div class="input-field col m6 s12">
<label for="ext">Exte</label>
<input id="ext" name="ext" value="<?php echo htmlentities($result->Exte);?>" type="tel" maxlength="10" autocomplete="off" >
 </div>
...
<input id="bg" name="bg" value="<?php echo htmlentities($result->BloodGroup);?>" type="tel" maxlength="10" autocomplete="off" >
 </div>

<div class="input-field col m6 s12">
<label for="password">Password</label>
<input id="password" name="password" value="<?php echo htmlentities($result->Password);?>" type="password" autocomplete="off" required>
</div>

<div class="input-field col m6 s12">
<label for="confirm">Confirm password</label>
<input id="confirm" name="confirmpassword" value="<?php echo htmlentities($result->Password);?>" type="password" autocomplete="off" required>
</div>
 </fieldset>
</div> 
</div>                                           
...
<option value="<?php echo htmlentities($result->Job);?>"><?php echo htmlentities($result->Job);?></option>                                           
...
<option value="<?php echo htmlentities($result->OO);?>"><?php echo htmlentities($result->OO);?></option>                                          
...
<option value="<?php echo htmlentities($result->Sub);?>"><?php echo htmlentities($result->Sub);?></option> 
...
<input id="twe" name="twe" value="<?php echo htmlentities($result->Twe);?>" type="text" autocomplete="off" >
</div>
<div class="input-field col m6 s12">
<label for="ijd">Infy Joining Date</label>
<input id="ijd" name="ijd" value="<?php echo htmlentities($result->Ijd);?>" type="date" class="datepicker" autocomplete="off" >
</div>
...
<input id="sa" name="sa" value="<?php echo htmlentities($result->Space);?>" type="text" autocomplete="off" >
</div>
</fieldset> 
<?php }}?>
