...
{               ?>  
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="../IVS_RTL_RAIL/index.php"><i class="material-icons">account_box</i>Home</a></li>                 
  <li class="no-padding"><a class="waves-effect waves-grey" href="myprofile.php"><i class="material-icons">account_box</i>My Profiles</a></li>
                   ...
                   <li class="no-padding"><a class="waves-effect waves-grey" href="ipt.php"><i class="material-icons">access_alarm</i>IPT</a></li>
